        ...
        const fetchUser = async () => {
            try {
                ...
                if (token) {
                    ...
                    const response = await fetch("https://adventurous-tux-worm.cyclic.app/api/users/profile", {
        ...
        const fetchUserOrders = async () => {
            try {
                ...
                if (token) {
                    ...
                    const response = await fetch("https://adventurous-tux-worm.cyclic.app/api/orders/userorders", {
                        headers: { Authorization: `Bearer ${token}` },
                    });
                    if (!response.ok) {
